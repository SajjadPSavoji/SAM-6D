...
class Net(nn.Module):
    ...
    def forward(self, end_points):
        dense_pm, dense_fm, all_po, all_fo, radius = self.feature_extraction(end_points)
        ...
        dense_po, dense_fo, fps_idx_o = sample_pts_and_feats_nonuniform(all_po, all_fo, all_scores2, fps_idx_o, self.fine_npoint)
